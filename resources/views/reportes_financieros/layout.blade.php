...
<div class="space-y-5">
 ...
 <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-xl border border-white/20 dark:border-gray-700/50 rounded-2xl p-4 flex flex-wrap items-center gap-2">
