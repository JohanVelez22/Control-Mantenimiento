 ...
 {{-- Resumen Consolidado (1 sola fila horizontal permanente homogénea) --}}
  ...
  <div class="glass-card p-6" style="padding-top: 18px;">
    <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-3" style="margin-bottom: 18px;">
        <div>
            <h3 class="text-lg font-bold text-slate-800 dark:text-white leading-tight">Resumen Consolidado del Período</h3>
        ...
        <div class="relative w-full sm:w-64 md:w-72 no-print">
            ...
            <input type="text" id="busqueda-rapida-reportes" placeholder="Búsqueda rápida..." class="glass-input pl-9 w-full text-sm font-semibold py-1.5 focus:ring-purple-500" onkeydown="if(event.key === 'Enter'){ event.preventDefault(); }">
        </div>
    </div>
