...
function agregarFila() {
    ...
    tr.innerHTML = `
        ...
        <td class="align-middle">
            ...
            <input type="text" id="precio_unitario_visual_${filaIndex}" value="" placeholder="0" oninput="window.formatCurrencyDual(this, 'precio_unitario_real_${filaIndex}'); recalcular()" required class="precio-input glass-input py-1.5 text-right focus:ring-blue-500 font-mono">
        </td>
