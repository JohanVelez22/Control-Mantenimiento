    ...
    <form method="POST" action="{{ route('clientes.store') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="mb-4">
                ...
                <input type="tel" pattern="[\d\+\-\s\(\)]+" name="movil" value="{{ old('movil') }}" required class="w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600 @error('movil') border-red-500 @enderror">
