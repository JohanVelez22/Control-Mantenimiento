...
<div class="max-w-4xl mx-auto">
 ...
 <div>
 <h2 class="text-2xl font-black text-slate-800 dark:text-white tracking-tight">✏️ Editar Cliente</h2>
 ...
 <input type="email" name="email" value="{{ old('email', $cliente->email) }}" class="glass-input mt-1 @error('email') border-red-500 @enderror">
