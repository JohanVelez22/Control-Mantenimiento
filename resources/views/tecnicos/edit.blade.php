...
<div class="max-w-4xl mx-auto">
 ...
 <input type="text" name="nombre" value="{{ old('nombre', $tecnico->nombre) }}" required oninput="this.value = this.value.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑ ]/g, '')" class="glass-input mt-1 @error('nombre') border-red-500 @enderror">
 ...
 <input type="text" name="identificacion" value="{{ old('identificacion', $tecnico->identificacion) }}" required oninput="this.value = this.value.replace(/[^0-9-]/g, '')" class="glass-input mt-1 @error('identificacion') border-red-500 @enderror">
 ...
 <input type="tel" name="movil" value="{{ old('movil', $tecnico->movil) }}" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="glass-input mt-1 @error('movil') border-red-500 @enderror">
