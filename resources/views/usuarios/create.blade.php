...
<div class="max-w-2xl mx-auto bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/50 p-8">
    ...
    <form method="POST" action="{{ route('usuarios.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ old('name') }}" required class="w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600 @error('name') border-red-500 @enderror">
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" value="{{ old('email') }}" required class="w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600 @error('email') border-red-500 @enderror">
