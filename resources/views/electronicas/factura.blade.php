...
<div class="info-grid" style="font-size: 7.5pt; margin-bottom: 2px;">
    <div class="info-col">
        <p style="font-size: 7.5pt; margin: 1px 0;"><strong>{{ $electronica->equipo?->propietario_tipo === 'proveedor' ? 'Proveedor:' : 'Cliente:' }}</strong> <strong>{{ $electronica->equipo?->propietario_nombre ?? 'N/A' }}</strong></p>
        <p style="font-size: 7.5pt; margin: 1px 0;"><strong>Teléfono:</strong> <strong>{{ $electronica->equipo?->propietario_telefono ?: 'N/A' }}</strong></p>
