...
<div class="max-w-4xl mx-auto bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-xl border border-white/20 dark:border-gray-700/50 rounded-2xl p-6">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-2xl font-bold">⚡ Nuevo Registro Electrónico</h2>
    </div>
    <form action="{{ route('electronicas.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button type="submit" class="px-6 py-2 rounded-xl bg-purple-500 text-white font-bold hover:bg-purple-600 shadow-lg shadow-purple-500/30 transition-all">Guardar Registro</button>
        </div>
    </form>
</div>
@endsection
