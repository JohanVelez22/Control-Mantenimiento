...
<div class="flex gap-4 mb-6 no-print overflow-x-auto pb-2">
 ...
 <a href="{{ route('electronicas.reportes') }}" class="px-4 py-2 rounded-xl font-bold shadow-lg transition-all bg-purple-500 text-white whitespace-nowrap">⚡ Reporte de Electrónica</a>
...
<div class="glass-card p-6 mb-6">
 ...
 <table class="ts-table table-electronica responsive-table reportes-tabla-imprimir w-full">
  ...
  <tr>
  <td class="text-center font-bold text-xs whitespace-nowrap">TOTAL: {{ $totales['cantidad'] }}</td>
