        ...
        <form method="POST" action="{{ route('mantenimientos.update', $mantenimiento->id) }}" id="mantenimientoForm" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="estado" required class="glass-input mt-1 font-bold {{ old('estado', $mantenimiento->estado) === 'terminado' ? 'text-emerald-600 dark:text-emerald-400' : 'text-yellow-600 dark:text-yellow-400' }}">
            ...
            <div class="flex flex-col md:flex-row justify-end gap-3 pt-6 border-t border-gray-200/50 dark:border-white/10 mt-6">
                <a href="{{ route('mantenimientos.index') }}" class="btn-ghost text-center py-3">Cancelar</a>
                <button type="submit" class="btn-primary shadow-yellow-500/30 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-600 hover:to-amber-600 border-none justify-center py-3 px-8 text-lg">
