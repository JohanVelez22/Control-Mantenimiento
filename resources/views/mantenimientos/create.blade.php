    ...
    <div class="glass-card p-6 md:p-8">
        ...
        <form method="POST" action="{{ route('mantenimientos.store') }}" id="mantenimientoForm" class="space-y-6">
            ...
            <div class="flex flex-col md:flex-row justify-end gap-3 pt-6 border-t border-gray-200/50 dark:border-white/10 mt-6">
                ...
                <button type="submit" class="btn-primary shadow-blue-500/30 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 border-none justify-center py-3 px-8 text-lg">
