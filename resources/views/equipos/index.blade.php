...
<div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-xl border border-white/20 dark:border-gray-700/50 rounded-2xl p-6">
    ...
    <!-- Búsqueda Rápida -->
    <div class="mb-4">
        <input type="text" id="search-equipos" placeholder="🔍 Buscar en tabla..." class="w-full md:w-80 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl py-2 px-4 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all">
    </div>
