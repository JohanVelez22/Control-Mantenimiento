...
<div class="max-w-4xl mx-auto">
 ...
 <input type="text" name="serie" value="{{ old('serie', $equipo->serie) }}" required placeholder="S/N..." oninput="this.value = this.value.toUpperCase()" class="glass-input mt-1 uppercase @error('serie') border-red-500 @enderror">
