...
<div class="flex gap-4 mb-6 no-print">
 ...
 <a href="<?php echo e(route('electronicas.reportes')); ?>" class="bg-purple-600 text-white px-4 py-2 rounded-xl font-bold shadow-sm">⚡ Reporte de Electrónica</a>
...
<div class="glass-card p-6 mb-6">
 ...
 <form id="filtros-electronica" action="<?php echo e(route('electronicas.reportes')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end mb-8 p-5 glass-card no-print relative z-50">
 <div>
 ...
 <input type="date" name="fecha_inicio" class="glass-input" value="<?php echo e(request('fecha_inicio', date('Y-m-01'))); ?>">
 </div>
 <div>
 <label class="block text-xs font-bold uppercase text-gray-500 dark:text-gray-400 mb-1">Hasta (Entrada)</label>
 <input type="date" name="fecha_fin" class="glass-input" value="<?php echo e(request('fecha_fin', date('Y-m-d'))); ?>">
 </div>
 <div>
 ...
 <option value="preventivo" <?php echo e(request('tipo') == 'preventivo' ? 'selected' : ''); ?>>Preventivo</option>
 <option value="correctivo" <?php echo e(request('tipo') == 'correctivo' ? 'selected' : ''); ?>>Correctivo</option>
 </select>
 </div>
 <div>
 ...
 <a href="<?php echo e(route('electronicas.reportes')); ?>" class="btn-clean">
 🧹 Limpiar
 </a>
 ...
 🌪️ Filtrar Reporte
  ...
  <div class="print-date hidden-screen">
   <p style="text-align: center; margin-top: 0; margin-bottom: 0; font-size: 10px; color: #4a5568;">Generado el: <?php echo e(date('d/m/Y h:i A')); ?> &nbsp;|&nbsp; Período: <?php echo e(request('fecha_inicio', date('Y-m-01'))); ?> al <?php echo e(request('fecha_fin', date('Y-m-d'))); ?></p>
  </div>
 ...
 <table class="ts-table table-electronica responsive-table reportes-tabla-imprimir w-full">
  ...
  <tbody>
  <?php $__empty_1 = true; $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
  <?php
  ...
  <a href="<?php echo e(route('electronicas.index', ['locate' => $m->id])); ?>" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:underline transition-colors no-print-link">
  ...
  <span class="text-slate-800 dark:text-white font-bold whitespace-nowrap group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors"><?php echo e($m->equipo->nombre ?? 'N/A'); ?></span>
  <span class="text-[10px] text-gray-500 tracking-wider uppercase mt-0.5">(<?php echo e($m->equipo->marca ?? ''); ?> <?php echo e($m->equipo->modelo ?? ''); ?>) - 
  <span class="text-[10px] text-gray-500 tracking-wider uppercase mt-0.5">
  ...
  <td class="text-center <?php echo e($dimLight); ?>">
  <span class="pill <?php echo e($m->estado == 'terminado' ? 'pill-done' : 'pill-pending'); ?>">
  ...
  <?php echo e($isAnulado ? 'Anulado' : 'Activo'); ?>
   ...
   <td class="text-center font-medium text-sm <?php echo e($dim); ?>">
  ...
  <tr>
  <td colspan="2" class="text-center font-bold text-xs whitespace-nowrap">TOTAL: <?php echo e($totales['cantidad']); ?></td>
  <td colspan="7" class="text-right uppercase text-xs">TOTAL FILTRADOS:</td>
  <td class="text-center font-bold text-xs text-green-600 dark:text-green-400">$<?php echo e(number_format($totales['costo'], 0, '', '.')); ?></td>
  </tr>
  </tfoot>
  <?php endif; ?>
 </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ServBay\www\control-mantenimiento-equipos\resources\views/electronicas/reportes.blade.php ENDPATH**/ ?>