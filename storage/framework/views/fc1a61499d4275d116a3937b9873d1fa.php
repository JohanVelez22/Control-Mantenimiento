...
<div class="glass-card p-6 mb-6">
 ...
 <table class="ts-table table-electronica responsive-table reportes-tabla-imprimir w-full">
  ...
  <tr>
  <td class="text-center font-bold">Total: <?php echo e($totales['cantidad']); ?></td>
  <td colspan="8" class="text-right uppercase text-xs">Total Filtrados:</td>
  <td class="text-center font-black text-green-600 dark:text-green-400">$<?php echo e(number_format($totales['costo'], 0, '', '.')); ?></td>
  </tr>
  </tfoot>
  <?php endif; ?>
 </table>
