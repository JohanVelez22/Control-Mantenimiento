    ...
    <div class="watermark-container <?php echo $__env->yieldContent('watermark_class'); ?>">
        <div class="header">
            <?php if($empresa->logo_path): ?>
                <img src="<?php echo e(Storage::url($empresa->logo_path)); ?>" alt="Logo" class="header-logo">
            <?php else: ?>
            ...
            <div class="header-info">
                ...
                <?php if($empresa->nit): ?><p>NIT: <?php echo e($empresa->nit); ?></p><?php endif; ?>
                <?php if($empresa->telefono): ?><p>Tel: <?php echo e($empresa->telefono); ?></p><?php endif; ?>
                <?php if($empresa->direccion): ?><p>Dir: <?php echo e($empresa->direccion); ?></p><?php endif; ?>
                <?php if($empresa->correo): ?><p>Email: <?php echo e($empresa->correo); ?></p><?php endif; ?>
            </div>
        </div>
