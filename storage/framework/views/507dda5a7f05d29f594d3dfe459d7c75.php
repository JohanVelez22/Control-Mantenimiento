...
<div class="glass-card p-6">
  ...
  <button type="button" onclick="openAnularModal('<?php echo e(route('mantenimientos.anular', $m->id)); ?>', <?php echo e($m->anulado ? 'true' : 'false'); ?>)" class="btn-ghost px-2.5 py-1.5 text-xs <?php echo e($m->anulado ? 'text-emerald-600 border-emerald-500/20 hover:bg-emerald-500/10' : 'text-red-600 border-red-500/20 hover:bg-red-500/10'); ?>" title="<?php echo e($m->anulado ? 'Reactivar orden' : 'Anular orden'); ?>">
