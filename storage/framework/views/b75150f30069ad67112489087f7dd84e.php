...
<div class="glass-card p-5 mb-4 no-print">
 ...
 bg-<?php echo e($mov['color']); ?>-100 text-<?php echo e($mov['color']); ?>-800
 dark:bg-<?php echo e($mov['color']); ?>-900/40 dark:text-<?php echo e($mov['color']); ?>-300">
 <?php echo e($mov['icono']); ?> <?php echo e(ucfirst($mov['tipo'])); ?>
 ...
 <td class="p-3 text-center font-bold <?php echo e($isAnulado ? '' : (in_array($mov['tipo'], ['ingreso','venta','mantenimiento','electronica']) ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400')); ?> <?php echo e($isAnulado ? '' : $dim); ?>" <?php echo $isAnulado ? 'style="color: #dd6b20 !important;"' : ''; ?>>
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   ...
   <tfoot>
    <tr class="bg-gray-100/50 dark:bg-gray-800/50 font-bold text-center">
        ...
        <td class="text-center font-black text-lg <?php echo e($color); ?>">$<?php echo e(number_format($neto, 0, ',', '.')); ?></td>
    </tr>
 </tfoot>
 </table>
 </div>
