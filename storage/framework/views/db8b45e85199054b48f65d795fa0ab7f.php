    ...
    <div class="glass-card p-6 md:p-8">
        ...
        <form action="<?php echo e(route('proveedores.store')); ?>" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col md:flex-row justify-end gap-3 pt-6 border-t border-gray-200/50 dark:border-white/10 mt-6">
                <a href="<?php echo e(route('proveedores.index')); ?>" class="btn-cancel">↩️ Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ServBay\www\control-mantenimiento-equipos\resources\views/proveedores/create.blade.php ENDPATH**/ ?>