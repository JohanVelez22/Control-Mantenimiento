...
<div class="glass-card p-6">
 ...
 <?php if($u->photo): ?>
 <img src="<?php echo e(asset('storage/' . $u->photo)); ?>" width="40" height="40" class="rounded-xl object-cover mx-auto shadow-sm">
 <?php else: ?>
 ...
 <?php if(auth()->user()->isAdmin() && auth()->id() !== $u->id): ?>
 <button type="button" onclick="openAnularModal('<?php echo e(route('usuarios.anular', $u->id)); ?>')" class="btn-ghost px-2.5 py-1.5 text-xs <?php echo e($u->active ? 'text-red-600' : 'text-emerald-600'); ?>" title="<?php echo e($u->active ? 'Anular Usuario' : 'Reactivar Usuario'); ?>">
 <?php echo e($u->active ? '🚫' : '✅'); ?>
