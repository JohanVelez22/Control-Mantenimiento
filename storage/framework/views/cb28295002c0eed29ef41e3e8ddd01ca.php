...
<div class="glass-card p-6 mb-6">
 ...
 🌪️ Filtrar Reporte
  ...
  <div class="print-date hidden-screen">
   <p style="text-align: center; margin-top: 0; margin-bottom: 0; font-size: 10px; color: #4a5568;">Generado el: <?php echo e(date('d/m/Y h:i A')); ?> &nbsp;|&nbsp; Período: <?php echo e(request('fecha_desde', date('Y-m-01'))); ?> al <?php echo e(request('fecha_hasta', date('Y-m-d'))); ?></p>
  </div>
