...
<div class="max-w-2xl mx-auto">
 ...
 <p class="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1">Actualiza la información de <?php echo e($proveedor->nombre_razon_social); ?></p>
 </div>
 </div>
 ...
 <a href="<?php echo e(route('proveedores.index')); ?>" class="btn-cancel">
 ↩️ Cancelar
 </a>
