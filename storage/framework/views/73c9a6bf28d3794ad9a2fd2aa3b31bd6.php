...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
 ...
 <div class="text-3xl font-black text-slate-800 dark:text-white z-10"><?php echo e($totalEquipos ?? 0); ?></div>
 </div>
 ...
 <div class="text-3xl font-black text-slate-800 dark:text-white z-10"><?php echo e($totalMantenimientos ?? 0); ?></div>
 </div>
 ...
 <div class="text-3xl font-black text-slate-800 dark:text-white z-10"><?php echo e($stats['pendientes'] ?? 0); ?></div>
 </div>
 ...
 <div class="text-3xl font-black text-slate-800 dark:text-white z-10"><?php echo e($stats['electronica_pendientes'] ?? 0); ?></div>
 </div>
 ...
 <div class="text-3xl font-black text-slate-800 dark:text-white z-10"><?php echo e($stats['stock_bajo'] ?? 0); ?></div>
 </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
 <?php $isSaldoNegativo = isset($cajaSaldoActual) && $cajaSaldoActual < 0; ?>
 <div class="glass-card p-4 flex flex-col justify-center relative overflow-hidden group items-center text-center">
 <div class="absolute -right-4 -top-4 w-20 h-20 <?php echo e($isSaldoNegativo ? 'bg-red-500/20 group-hover:bg-red-500/30' : 'bg-emerald-500/20 group-hover:bg-emerald-500/30'); ?> rounded-full blur-2xl transition-all"></div>
 <div class="text-xs font-bold <?php echo e($isSaldoNegativo ? 'text-red-600 dark:text-red-400' : 'text-emerald-600 dark:text-emerald-400'); ?> uppercase tracking-widest mb-1 z-10 flex items-center gap-1.5 justify-center"><span class="text-lg">💰</span> Saldo en Caja (Histórico)</div>
 <div class="text-2xl font-black <?php echo e($isSaldoNegativo ? 'text-red-600 dark:text-red-400' : 'text-slate-800 dark:text-white'); ?> z-10"><?php echo e($isSaldoNegativo ? '-' : ''); ?>$<?php echo e(number_format(abs($cajaSaldoActual ?? 0), 0, ',', '.')); ?></div>
 </div>
 <?php $isSaldoDiaNegativo = isset($cajaSaldoDia) && $cajaSaldoDia < 0; ?>
 <div class="glass-card p-4 flex flex-col justify-center relative overflow-hidden group items-center text-center">
 <div class="absolute -right-4 -top-4 w-20 h-20 <?php echo e($isSaldoDiaNegativo ? 'bg-red-500/20 group-hover:bg-red-500/30' : 'bg-blue-500/20 group-hover:bg-blue-500/30'); ?> rounded-full blur-2xl transition-all"></div>
 <div class="text-xs font-bold <?php echo e($isSaldoDiaNegativo ? 'text-red-600 dark:text-red-400' : 'text-blue-600 dark:text-blue-400'); ?> uppercase tracking-widest mb-1 z-10 flex items-center gap-1.5 justify-center"><span class="text-lg">💵</span> Balance Caja (Hoy)</div>
 <div class="text-2xl font-black <?php echo e($isSaldoDiaNegativo ? 'text-red-600 dark:text-red-400' : 'text-slate-800 dark:text-white'); ?> z-10"><?php echo e($isSaldoDiaNegativo ? '-' : ''); ?>$<?php echo e(number_format(abs($cajaSaldoDia ?? 0), 0, ',', '.')); ?></div>
 </div>
</div>
...
<div class="glass-card p-6 md:p-8 pb-4 md:pb-5">
 ...
 <tbody class="text-sm">
 <?php $__empty_1 = true; $__currentLoopData = $recentMant ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
 <?php
 ...
 <a href="<?php echo e(route('mantenimientos.index', ['locate' => $m->id])); ?>" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:underline no-print-link">
 ...
 <a href="<?php echo e(route('equipos.index')); ?>#equipo-<?php echo e($m->equipo_id); ?>" class="flex items-baseline justify-center gap-1 hover:opacity-75 transition-opacity group no-print-link" title="Ver en tabla de equipos">
 ...
 <span class="font-bold text-gray-900 dark:text-white">$<?php echo e(number_format($m->costo, 0, ',', '.')); ?></span>
 <?php if($m->total_abonado > 0): ?>
 <span class="text-[11px] font-semibold text-green-600">Abonado: $<?php echo e(number_format($m->total_abonado, 0, ',', '.')); ?></span>
 <span class="text-[11px] font-semibold text-red-500">Saldo: $<?php echo e(number_format($m->saldo_pendiente, 0, ',', '.')); ?></span>
 <?php endif; ?>
 </div>
 </td>

 <td class="text-center <?php echo e($dimLight); ?>">
 <span class="pill <?php echo e($m->estado == 'terminado' ? 'pill-done' : 'pill-pending'); ?> <?php echo e($m->anulado ? 'opacity-70' : ''); ?>">
 <?php echo e(strtoupper($m->estado)); ?>
 ...
 <td class="text-center whitespace-nowrap text-gray-600 dark:text-gray-300 <?php echo e($dim); ?>"><?php echo e($fechaEntrada->format('d/m/Y')); ?></td>
 
 <td class="text-center font-bold <?php echo e($dim); ?>">
 <span class="<?php echo e(!$m->fecha_salida && $diasTranscurridos > 3 ? 'text-red-500' : 'text-gray-600 dark:text-gray-400'); ?>">
 <?php echo e($diasTranscurridos); ?>

 </span>
 </td>

 <td class="text-center whitespace-nowrap <?php echo e($m->fecha_salida ? 'text-gray-800 dark:text-gray-200' : 'text-gray-400 italic'); ?> <?php echo e($dim); ?>">
 <?php echo e($m->fecha_salida ? \Carbon\Carbon::parse($m->fecha_salida)->format('d/m/Y') : 'En proceso'); ?>
 ...
 <?php endif; ?>
    ...
    <div class="mt-4 md:mt-5 text-right">
        <a href="<?php echo e(route('mantenimientos.reportes')); ?>" class="btn-primary">
 ...
 <tbody class="text-sm">
 <?php $__empty_1 = true; $__currentLoopData = $recentElec ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
 <?php
 ...
 <tr>
 <td class="text-center font-bold whitespace-nowrap <?php echo e($dim); ?>">
 <a href="<?php echo e(route('electronicas.index', ['locate' => $e->id])); ?>" class="text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 hover:underline no-print-link">
 ...
 <td class="text-center <?php echo e($dim); ?>">
 <a href="<?php echo e(route('equipos.index')); ?>#equipo-<?php echo e($e->equipo_id); ?>" class="flex items-baseline justify-center gap-1 hover:opacity-75 transition-opacity group no-print-link" title="Ver en tabla de equipos">
 <span class="font-bold text-slate-800 dark:text-white whitespace-nowrap group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
 ...
 <td class="text-center font-bold text-gray-900 dark:text-white <?php echo e($dim); ?>">
 ...
 <?php echo e(strtoupper($e->estado)); ?>
 ...
 <td class="text-center font-bold <?php echo e($dim); ?>">
 <span class="<?php echo e(!$e->fecha_salida && $diasTranscurridos > 3 ? 'text-red-500' : 'text-gray-600 dark:text-gray-400'); ?>">
 <?php echo e($diasTranscurridos); ?>

 </span>
 </td>

 <td class="text-center whitespace-nowrap <?php echo e($e->fecha_salida ? 'text-gray-800 dark:text-gray-200' : 'text-gray-400 italic'); ?> <?php echo e($dim); ?>">
 <?php echo e($e->fecha_salida ? \Carbon\Carbon::parse($e->fecha_salida)->format('d/m/Y') : 'En proceso'); ?>
 ...
 <?php endif; ?>
    ...
    <div class="mt-4 md:mt-5 text-right">
        <a href="<?php echo e(route('electronicas.reportes')); ?>" class="btn-purple">
 📈 Ver reporte detallado →
 </a>
 </div>
 </div>
...
<script>
 ...
 plugins: [centerTextPlugin],
        data: {
            ...
            datasets: [{
                data: [
                    <?php echo e($stats['pendientes'] ?? 0); ?>,
                    <?php echo e($stats['terminados'] ?? 0); ?>
 ...
 labels: ['Pendientes', 'Terminados'],
 datasets: [{
 data: [<?php echo e($chartData['electronicaPendientes']); ?>, <?php echo e($chartData['electronicaTerminados']); ?>],
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ServBay\www\control-mantenimiento-equipos\resources\views/dashboard.blade.php ENDPATH**/ ?>