...
<div class="w-full max-w-lg px-6 pb-8">
 ...
 <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="Tu nombre completo"
 ...
 <input type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="usuario@empresa.com"
 class="glass-input mt-1">
 </div>
 ...
 class="glass-input mt-1 <?php $__errorArgs = ['admin_password'];
...
$message = $__bag->first($__errorArgs[0]); ?>
 <p class="text-xs text-red-500 mt-1 font-semibold"><?php echo e($message); ?></p>
 <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
 ...
 ¿Ya tienes cuenta?
 <a href="<?php echo e(route('login')); ?>" class="text-blue-600 dark:text-blue-400 font-bold hover:text-blue-700 dark:hover:text-blue-300 transition-colors ml-1">
 Inicia sesión
 </a>
 </p>
 </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ServBay\www\control-mantenimiento-equipos\resources\views/auth/register.blade.php ENDPATH**/ ?>