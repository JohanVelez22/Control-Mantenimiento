...
<div class="max-w-4xl mx-auto">
 ...
 <form method="POST" action="<?php echo e(route('equipos.store')); ?>" class="space-y-6">
 <?php echo csrf_field(); ?>
 ...
 <input type="text" name="nombre" value="<?php echo e(old('nombre')); ?>" required placeholder="Ej. PC Escritorio" class="glass-input mt-1 <?php $__errorArgs = ['nombre'];
...
unset($__errorArgs, $__bag); ?>
 ...
 <input type="text" name="marca" value="<?php echo e(old('marca')); ?>" required placeholder="Ej. HP, Dell" class="glass-input mt-1 <?php $__errorArgs = ['marca'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
 ...
 <input type="text" name="modelo" value="<?php echo e(old('modelo')); ?>" required placeholder="Ej. ProDesk 400" class="glass-input mt-1 <?php $__errorArgs = ['modelo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
 ...
 <input type="text" name="serie" value="<?php echo e(old('serie')); ?>" required placeholder="S/N..." oninput="this.value = this.value.toUpperCase()" class="glass-input mt-1 uppercase <?php $__errorArgs = ['serie'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
 ...
 <textarea name="observacion" rows="3" class="glass-input mt-1 resize-y" placeholder="Cargador original, rayón en la tapa, etc..."><?php echo e(old('observacion')); ?></textarea>
 </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ServBay\www\control-mantenimiento-equipos\resources\views/equipos/create.blade.php ENDPATH**/ ?>