...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Tarjetas resumen */
        .summary-grid { display: table; width: 100%; margin-bottom: 2px; border-spacing: 4px 2px; }
...
<body>
    ...
    <div class="summary-grid" style="margin-bottom: 2px;">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:center"><?php echo e($acumulado['total_anulados'] ?? 0); ?></td>
        ...
        <tfoot>
            <tr>
                ...
                <td style="text-align:center; padding: 5px 6px; color:#ffffff; font-weight:800;">TOTAL REGISTROS: <?php echo e($totalRegistros); ?></td>
                <td style="text-align:center; padding: 5px 6px; color:#ffffff; font-weight:800;">BALANCE NETO: $<?php echo e(number_format($acumulado['balance_neto'] ?? 0, 0, ',', '.')); ?></td>
            </tr>
        </tfoot>
    </table>
