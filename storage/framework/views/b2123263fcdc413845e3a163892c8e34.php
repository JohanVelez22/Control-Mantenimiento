<?php $__env->startSection('title', 'Comprobante de Caja ' . $movimiento->id); ?>

<?php $__env->startSection('watermark_class', $movimiento->anulado ? 'anulado' : ''); ?>

<?php $__env->startSection('doc_title'); ?>
    COMPROBANTE DE <?php echo e(Str::upper($movimiento->tipo_movimiento)); ?> A CAJA - #<?php echo e($movimiento->id); ?>
