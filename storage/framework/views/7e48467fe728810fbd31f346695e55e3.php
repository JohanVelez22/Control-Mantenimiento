...
<div class="glass-card p-6">
 ...
 <button type="button" onclick="openAnularModal('<?php echo e(route('stocks.anular', $stock->id)); ?>')" class="btn-ghost px-3 py-1.5 text-xs <?php echo e($stock->active ? 'text-red-600' : 'text-emerald-600'); ?>" title="<?php echo e($stock->active ? 'Anular Producto' : 'Reactivar Producto'); ?>">
