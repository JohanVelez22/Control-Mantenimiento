...
<div class="max-w-4xl mx-auto">
    ...
    <form action="<?php echo e(route('configuracion.update')); ?>" method="POST" enctype="multipart/form-data" class="glass-card p-6 md:p-8 space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-1/3 flex flex-col items-center gap-4">
                <div class="w-48 h-48 rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-700 bg-white/50 dark:bg-slate-800/50 flex flex-col items-center justify-center overflow-hidden relative group cursor-pointer" onclick="document.getElementById('logo-input').click()">
                    <?php if($configuracion->logo_path): ?>
                        <img src="<?php echo e(Storage::url($configuracion->logo_path)); ?>" id="logo-preview" alt="Logo Empresa" class="w-full h-full object-contain p-2 z-10 bg-white dark:bg-transparent">
            ...
            <div class="w-full md:w-2/3 space-y-4">
                <div>
                    ...
                    <input type="text" name="nombre" value="<?php echo e(old('nombre', $configuracion->nombre)); ?>" required class="glass-input font-bold">
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="field-label">NIT / Documento</label>
                        <input type="text" name="nit" value="<?php echo e(old('nit', $configuracion->nit)); ?>" class="glass-input">
                    </div>
                    <div>
                        <label class="field-label">Teléfono de Contacto</label>
                        <input type="text" name="telefono" value="<?php echo e(old('telefono', $configuracion->telefono)); ?>" class="glass-input">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="email" name="correo" value="<?php echo e(old('correo', $configuracion->correo)); ?>" class="glass-input">
                    </div>
                    <div>
                        <label class="field-label">Dirección / Sucursal</label>
                        <input type="text" name="direccion" value="<?php echo e(old('direccion', $configuracion->direccion)); ?>" class="glass-input">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="pie_pagina_factura" rows="4" class="glass-input" placeholder="Ej: Gracias por su compra. Los equipos reparados tienen garantía de 3 meses."><?php echo e(old('pie_pagina_factura', $configuracion->pie_pagina_factura)); ?></textarea>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ServBay\www\control-mantenimiento-equipos\resources\views/configuracion/index.blade.php ENDPATH**/ ?>