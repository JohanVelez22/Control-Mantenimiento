...
<?php if($tecnico->photo): ?>
  <img src="<?php echo e(asset('storage/' . $tecnico->photo)); ?>" width="40" height="40" class="rounded-xl object-cover mx-auto shadow-sm cursor-pointer hover:opacity-80 transition" onclick="openImageLightbox('<?php echo e(asset('storage/' . $tecnico->photo)); ?>', '<?php echo e(addslashes($tecnico->nombre)); ?>')">
  <?php else: ?>
