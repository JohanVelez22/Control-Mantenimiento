...
<div class="info-grid">
    ...
    <div class="info-col">
        <p><strong>Código / Ref:</strong> <span style="font-family: monospace;"><?php echo e($stock->codigo ?: '—'); ?></span></p>
...
<table class="items-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            ?>
            <td class="text-center" style="color: #6b21a8; font-weight: bold;">+<?php echo e(number_format($utilidadTecnico, 0)); ?>%</td>
            <td class="text-right" style="color: #6b21a8; font-weight: bold;">$<?php echo e(number_format($stock->precio_tecnico, 0, ',', '.')); ?></td>
        </tr>
        <tr style="background-color: #fafafa;">
            <td class="font-bold">Precio de Venta Público (PVP)</td>
            <td class="text-center font-bold" style="color: #166534;">+<?php echo e(number_format($stock->utilidad ?? 0, 0)); ?>%</td>
            <td class="text-right font-bold" style="color: #166534;">$<?php echo e(number_format($stock->precio_venta, 0, ',', '.')); ?></td>
        </tr>
    </tbody>
</table>
