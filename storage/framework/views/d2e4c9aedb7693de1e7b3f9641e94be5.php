...
<td data-label="Fecha:" class="text-center font-medium <?php echo e($dim); ?>"><?php echo e($m->fecha->format('d/m/Y')); ?></td>
 ...
 <button type="button" onclick="openAnularModal('<?php echo e(route('caja.anular', $m->id)); ?>')" class="btn-ghost px-3 py-1.5 text-xs <?php echo e($m->anulado ? 'grayscale opacity-60 hover:bg-gray-500/10' : 'text-red-600 border-red-500/20 hover:bg-red-500/10'); ?>" title="<?php echo e($m->anulado ? 'Reactivar movimiento' : 'Anular movimiento'); ?>">
