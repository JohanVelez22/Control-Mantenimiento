...
<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="md:col-span-1">
            <form action="<?php echo e(route('conceptos.store')); ?>" method="POST" class="glass-card p-6">
                <?php echo csrf_field(); ?>
        ...
        <div class="md:col-span-2">
            <div class="glass-card p-6">
                ...
                <ul class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $conceptos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="flex items-center justify-between p-3 bg-white/50 dark:bg-slate-800/50 rounded-xl border border-gray-200/50 dark:border-white/5">
                        <form action="<?php echo e(route('conceptos.update', $c->id)); ?>" method="POST" class="flex-1 flex gap-2 mr-4">
                            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                            <input type="text" name="nombre" value="<?php echo e($c->nombre); ?>" required class="glass-input flex-1 py-1.5 px-3 text-sm">
                        ...
                        <button type="button" onclick="openDeletePwd('<?php echo e(route('conceptos.destroy', $c->id)); ?>')" class="btn-danger px-3 py-1.5 text-xs">🗑️</button>
                    </li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ServBay\www\control-mantenimiento-equipos\resources\views/caja/conceptos/index.blade.php ENDPATH**/ ?>