...
<div class="max-w-5xl mx-auto">
 ...
 <form action="<?php echo e(route('inventario.compra.store')); ?>" method="POST" id="compra-form" class="space-y-5">
 <?php echo csrf_field(); ?>
 ...
 <option value="Cliente:<?php echo e($cli->id); ?>" <?php echo e(old('facturable_global') == "Cliente:{$cli->id}" ? 'selected' : ''); ?>>
 👤 Cliente: <?php echo e($cli->nombre); ?> (<?php echo e($cli->identificacion ?? 'Cliente'); ?>)
 </option>
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
 </select>
...
unset($__errorArgs, $__bag); ?>
 ...
 <input type="date" name="fecha" required value="<?php echo e(old('fecha', date('Y-m-d'))); ?>" class="glass-input focus:ring-orange-500">
...
unset($__errorArgs, $__bag); ?>
 ...
 <option value="<?php echo e($s->id); ?>" data-precio="<?php echo e($s->precio_compra); ?>">
 <?php echo e($s->producto); ?> (Stock: <?php echo e($s->cantidad); ?>) — P.Compra: $<?php echo e(number_format($s->precio_compra, 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ServBay\www\control-mantenimiento-equipos\resources\views/inventario/compra.blade.php ENDPATH**/ ?>