...
# Replace the entire <header id="ts-topbar"> ... </header> safely
header_pattern = r'<header id="ts-topbar".*?</header>'
new_header = """<header id="ts-topbar" class="h-16 px-4 md:px-6 flex items-center justify-between no-print">
